export const SG_ABI = [
  ...
  "function getOrderParties(uint256 id) view returns (address,address,address,address)",
  ...
  "function getOrderEscrow(uint256 id) view returns (uint256 escrowed,bool advanceFunded,bool advancePaid)",
  ...
  // write
  "function createOrderHeader(address buyer,address seller,address carrier,address inspector,address token,uint256 price,uint16 advanceBps,(uint256) odl) returns (uint256)",
  ...
  "function fundAdvance(uint256 id)",
  ...
  "function fundMilestone(uint256 id,uint8 idx)",
  ...
  "function cancelByAdmin(uint256 id,string note)",
  ...
  "event DocSubmitted(uint256 indexed orderId,uint8 indexed t,uint8 indexed idx,bytes32 hash32,address by)",
